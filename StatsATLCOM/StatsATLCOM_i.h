...
EXTERN_C const IID IID_IStatsLibWrapper;
    ...
    typedef struct IStatsLibWrapperVtbl
    {
        ...
        DECLSPEC_XFGVIRT(IStatsLibWrapper, DescriptiveStatistics)
        ...
        DECLSPEC_XFGVIRT(IStatsLibWrapper, LinearRegression)
...
EXTERN_C const IID IID_IStatisticalTest;
    ...
    typedef struct IStatisticalTestVtbl
    {
        ...
        DECLSPEC_XFGVIRT(IStatisticalTest, SummaryDataTTest)
        ...
        DECLSPEC_XFGVIRT(IStatisticalTest, OneSampleTTest)
        ...
        DECLSPEC_XFGVIRT(IStatisticalTest, TwoSampleTTest)
