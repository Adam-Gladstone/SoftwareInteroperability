...
// Construction
//
CDataSetsDlg::CDataSetsDlg(const std::vector<StatisticsLibrary::DataSetInfo>& data_sets, CWnd* pParent /*=nullptr*/)
...
{
    [[maybe_unused]] const int count = m_lbDataSets.GetSelCount();
