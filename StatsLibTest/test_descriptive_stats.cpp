...
TEST(DescriptiveStatsTests, TestDescriptiveStatisticsNoData)
{
	...
	// Act / Assert
	EXPECT_THROW([[maybe_unused]] const auto results = GetDescriptiveStatistics(v, keys), std::invalid_argument);
}
...
TEST(DescriptiveStatsTests, TestMeanNoData)
{
	...
	// Act / Assert
	EXPECT_THROW([[maybe_unused]]const auto results = DescriptiveStatistics::Mean(v), std::invalid_argument);
}
...
TEST(DescriptiveStatsTests, TestStandardErrorNoData)
{
	...
	// Act / Assert
	EXPECT_THROW([[maybe_unused]] const auto results = DescriptiveStatistics::StandardError(v, var_type), std::invalid_argument);
}
...
TEST(DescriptiveStatsTests, TestMedianNoData)
{
	...
	// Act / Assert
	EXPECT_THROW([[maybe_unused]] const auto results = DescriptiveStatistics::Median(v), std::invalid_argument);
}
...
TEST(DescriptiveStatsTests, TestStandardDeviationNoData)
{
	...
	// Act / Assert
	EXPECT_THROW([[maybe_unused]] const auto results = DescriptiveStatistics::StandardDeviation(v, var_type), std::invalid_argument);
}
...
TEST(DescriptiveStatsTests, TestVarianceNoData)
{
	...
	// Act / Assert
	EXPECT_THROW([[maybe_unused]] const auto results = DescriptiveStatistics::Variance(v, var_type), std::invalid_argument);
}
...
TEST(DescriptiveStatsTests, TestSkewNoData)
{
	...
	// Act / Assert
	EXPECT_THROW([[maybe_unused]] const auto results = DescriptiveStatistics::Skew(v), std::invalid_argument);
}
...
TEST(DescriptiveStatsTests, TestKurtosisNoData)
{
	...
	// Act / Assert
	EXPECT_THROW([[maybe_unused]] const auto results = DescriptiveStatistics::Kurtosis(v), std::invalid_argument);
}
...
TEST(DescriptiveStatsTests, TestExcessKurtosisNoData)
{
	...
	// Act / Assert
	EXPECT_THROW([[maybe_unused]] const auto results = DescriptiveStatistics::ExcessKurtosis(v), std::invalid_argument);
}
...
TEST(DescriptiveStatsTests, TestRangeNoData)
{
	...
	// Act / Assert
	EXPECT_THROW([[maybe_unused]] const auto results = DescriptiveStatistics::Range(v), std::invalid_argument);
}
...
TEST(DescriptiveStatsTests, TestMinimumNoData)
{
	...
	// Act / Assert
	EXPECT_THROW([[maybe_unused]] const auto results = DescriptiveStatistics::Minimum(v), std::invalid_argument);
}
...
TEST(DescriptiveStatsTests, TestMaximumNoData)
{
	...
	// Act / Assert
	EXPECT_THROW([[maybe_unused]] const auto results = DescriptiveStatistics::Maximum(v), std::invalid_argument);
}
...
TEST(DescriptiveStatsTests, TestProductNoData)
{
	...
	// Act / Assert
	EXPECT_THROW([[maybe_unused]] const auto results = DescriptiveStatistics::Product(v), std::invalid_argument);
}
