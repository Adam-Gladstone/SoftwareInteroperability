...
RcppExport SEXP _StatsR_z_test_summary_data(SEXP mu0SEXP, SEXP meanSEXP, SEXP sdSEXP, SEXP nSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type mu0(mu0SEXP);
    ...
    Rcpp::traits::input_parameter< double >::type sd(sdSEXP);
    Rcpp::traits::input_parameter< double >::type n(nSEXP);
    rcpp_result_gen = Rcpp::wrap(z_test_summary_data(mu0, mean, sd, n));
    return rcpp_result_gen;
END_RCPP
}
// z_test_one_sample
std::unordered_map<std::string, double> z_test_one_sample(double mu0, Rcpp::NumericVector x1);
RcppExport SEXP _StatsR_z_test_one_sample(SEXP mu0SEXP, SEXP x1SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type mu0(mu0SEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type x1(x1SEXP);
    rcpp_result_gen = Rcpp::wrap(z_test_one_sample(mu0, x1));
    return rcpp_result_gen;
END_RCPP
}
// z_test_two_sample
std::unordered_map<std::string, double> z_test_two_sample(Rcpp::NumericVector x1, Rcpp::NumericVector x2);
RcppExport SEXP _StatsR_z_test_two_sample(SEXP x1SEXP, SEXP x2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type x1(x1SEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type x2(x2SEXP);
    rcpp_result_gen = Rcpp::wrap(z_test_two_sample(x1, x2));
    return rcpp_result_gen;
END_RCPP
}
// library_version
...
RcppExport SEXP _StatsR_get_moving_average(SEXP datesSEXP, SEXP observationsSEXP, SEXP windowSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type dates(datesSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type observations(observationsSEXP);
    Rcpp::traits::input_parameter< int >::type window(windowSEXP);
    rcpp_result_gen = Rcpp::wrap(get_moving_average(dates, observations, window));
    return rcpp_result_gen;
END_RCPP
}

RcppExport SEXP _rcpp_module_boot_StatsTests();
RcppExport SEXP _rcpp_module_boot_TS();
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_StatsR_z_test_summary_data", (DL_FUNC) &_StatsR_z_test_summary_data, 4},
    {"_StatsR_z_test_one_sample", (DL_FUNC) &_StatsR_z_test_one_sample, 2},
    {"_StatsR_z_test_two_sample", (DL_FUNC) &_StatsR_z_test_two_sample, 2},
    {"_StatsR_library_version", (DL_FUNC) &_StatsR_library_version, 0},
    {"_StatsR_get_moving_average", (DL_FUNC) &_StatsR_get_moving_average, 3},
    {"_rcpp_module_boot_StatsTests", (DL_FUNC) &_rcpp_module_boot_StatsTests, 0},
    {"_rcpp_module_boot_TS", (DL_FUNC) &_rcpp_module_boot_TS, 0},
    {NULL, NULL, 0}
};
